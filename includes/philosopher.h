...
/* checks */
void						check_died(struct s_philo *philo,
								struct s_data_shared *data);
int							has_died(struct s_philo *philo,
								struct s_data_shared *data);

/* assign */
void						assign_struct(struct s_philo **philo,
								struct s_data_shared *data);
...
/* Threads */
void						create_threads(struct s_philo **philo,
								struct s_data_shared *data);
void						destroy_threads(struct s_philo **philo,
								struct s_data_shared *data);
...
void						write_in_stdout(struct s_philo *philo,
								struct s_data_shared *data, char *state);
